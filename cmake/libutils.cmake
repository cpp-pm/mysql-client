  ...
  FOREACH(LIB ${LIBS_TO_MERGE})
    ...
    ELSE()
      ...
      IF(LIB_TYPE STREQUAL "STATIC_LIBRARY")
        ...
        SET(STATIC_LIBS_DEBUG ${STATIC_LIBS_DEBUG} ${LIB_LOCATION_DEBUG})
  ...
  IF(MSVC)
    ...
    IF(CMAKE_CONFIGURATION_TYPES)
      FOREACH(CONFIG_TYPE ${CMAKE_CONFIGURATION_TYPES})
        ...
        SET_TARGET_PROPERTIES(${TARGET} PROPERTIES STATIC_LIBRARY_FLAGS_${CONFIG_TYPE}
          "${LINKER_EXTRA_FLAGS__${CONFIG_TYPE}}")
      ENDFOREACH()
    ELSE()
      SET(LINKER_EXTRA_FLAGS_${CMAKE_BUILD_TYPE} "")

      FOREACH(LIB ${STATIC_LIBS})
        SET(LINKER_EXTRA_FLAGS_${CMAKE_BUILD_TYPE} "${LINKER_EXTRA_FLAGS_${CMAKE_BUILD_TYPE}} ${LIB}")
      ENDFOREACH()

      SET_TARGET_PROPERTIES(${TARGET} PROPERTIES STATIC_LIBRARY_FLAGS_${CMAKE_BUILD_TYPE}
        "${LINKER_EXTRA_FLAGS__${CMAKE_BUILD_TYPE}}")
    ENDIF()
  ELSE()
