...
MACRO(MERGE_STATIC_LIBS TARGET OUTPUT_NAME LIBS_TO_MERGE)
  ...
  ELSE()
    ...
    SET(CONFIGURATION_TYPES ${BUILD_TYPE})
  ENDIF()
  ...
  FOREACH(CONFIG_TYPE ${CONFIGURATION_TYPES})
    IF(STATIC_LIBS_${CONFIG_TYPE})
      LIST(REMOVE_DUPLICATES STATIC_LIBS_${CONFIG_TYPE})
    ENDIF()
  ENDFOREACH()

  IF(MSVC)
    # To merge libs, just pass them to lib.exe command line, per build type
    FOREACH(CONFIG_TYPE ${CONFIGURATION_TYPES})
      message(STATUS "${CONFIG_TYPE}: ${STATIC_LIBS_${CONFIG_TYPE}}")
      SET(LINKER_EXTRA_FLAGS "")
      FOREACH(LIB ${STATIC_LIBS_${CONFIG_TYPE}})
          SET(LINKER_EXTRA_FLAGS "${LINKER_EXTRA_FLAGS} ${LIB}")
      ENDFOREACH()
      message(STATUS "${CONFIG_TYPE}: ${LINKER_EXTRA_FLAGS}")
      SET_TARGET_PROPERTIES(${TARGET} PROPERTIES STATIC_LIBRARY_FLAGS_${CONFIG_TYPE} "${LINKER_EXTRA_FLAGS}")

    ENDFOREACH()
  ELSE()
    FOREACH(CONFIG_TYPE ${CONFIGURATION_TYPES})
      GET_TARGET_PROPERTY(TARGET_LOCATION ${TARGET} LOCATION_${CONFIG_TYPE}) 
      SET(STATIC_LIBS ${STATIC_LIBS_${CONFIG_TYPE}})
