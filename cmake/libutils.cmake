...
MACRO(MERGE_STATIC_LIBS TARGET OUTPUT_NAME LIBS_TO_MERGE)
  ...
  FOREACH(LIB ${LIBS_TO_MERGE})
    ...
    GET_TARGET_PROPERTY(LIB_LOCATION_DEBUG ${LIB} LOCATION_DEBUG)
  ...
  IF(MSVC)
    ...
    ENDFOREACH()
    FOREACH(LIB ${STATIC_LIBS_DEBUG})
      SET(LINKER_EXTRA_FLAGS_DEBUG "${LINKER_EXTRA_FLAGS_DEBUG} ${LIB}")
    ENDFOREACH()
    SET_TARGET_PROPERTIES(${TARGET} PROPERTIES STATIC_LIBRARY_FLAGS_RELEASE
      "${LINKER_EXTRA_FLAGS}")
      SET_TARGET_PROPERTIES(${TARGET} PROPERTIES STATIC_LIBRARY_FLAGS_DEBUG 
